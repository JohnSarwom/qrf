...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="w-9 h-9 rounded-full bg-slate-800/50 dark:bg-slate-700/50 border border-slate-700 dark:border-slate-600 hover:bg-slate-700/70 dark:hover:bg-slate-600/70 transition-all duration-300"
    >
